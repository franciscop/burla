...
describe("burla.URL().query", () => {
  ...
  it("accepts arrays in queries", () => {
    const url = URL("http://localhost/?a[]=b");
    expect(url.query.a).toEqual(["b"]);
  });
...
describe("burla.URL().query", () => {
  ...
  it("accepts arrays in queries", () => {
    expect(url.URL("http://localhost/?a[]=b").query.a).toEqual(["b"]);
  });

  it("accepts duplicated keys in queries", () => {
    expect(url.URL("http://localhost/?a=b&c=d&a=e").query.a).toBe("e");
  });
});
